...
export default function SignupForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload = { name, email, phone, company, page: 'sales-solutions-lead-gen' };
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="mb-3">
        ...
        <input id="lead-phone" name="phone" className="form-control" value={phone} onChange={(e) => setPhone(e.target.value)} />
      </div>
      <div className="mb-3">
