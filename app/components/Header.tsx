              ...
              <div className="collapse navbar-collapse justify-content-start" id="navbarSupportedContent">
                <ul className="navbar-nav">
                  ...
                  <li className={`nav-item dropdown${isCompany ? ' active' : ''}`}>
                    <a href="#" className={`nav-link dropdown-toggle${isCompany ? ' active' : ''}`} data-bs-toggle="dropdown" role="button" aria-expanded="false">
                  ...
                  <li className={`nav-item dropdown${isServices ? ' active' : ''}`}>
                    <a href="#" className={`nav-link dropdown-toggle${isServices ? ' active' : ''}`} data-bs-toggle="dropdown" role="button" aria-expanded="false">
